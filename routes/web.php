...
Route::middleware(['auth', 'role:mahasiswa'])->prefix('user')->group(function () {
    Route::get('/dashboard', [KegiatanController::class, 'listForUser'])->name('user.dashboard');
    Route::get('/daftar-panitia', [KegiatanController::class, 'daftarPanitia'])->name('user.daftar-panitia');
