...
<div class="main-content">
    ...
    <div class="report-history">
        ...
        <div id="report-list">
            ...
            <div class="report-item" data-status="resolved">
                ...
                <div class="report-content" style="display: none;">
                    <div class="report-message">
                        <p>Nama saya tertulis "Adinda Pramesti" seharusnya "Adinda Paramesti" di sertifikat kegiatan
                            PKKMB 2025.</p>
                    </div>
                    <div class="admin-feedback">
                        <p><span class="admin-name">Admin Pusat</span> <span class="admin-date">15 Mei 2025,
                                10:23</span></p>
                        <p>Terima kasih atas laporannya. Sertifikat telah diperbaiki dan dapat diunduh kembali pada menu
                            Sertifikat.</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Report Item 2 -->
            <div class="report-item" data-status="processing">
                <div class="report-header" onclick="toggleReport(this)">
                    <div style="display: flex; align-items: center;">
                        <h3>File dokumentasi tidak bisa diakses</h3>
                        <span class="report-date">10 Mei 2025</span>
                    </div>
                    <span class="report-status status-processing">Diproses</span>
                </div>
                <div class="report-content" style="display: none;">
                    <div class="report-message">
                        <p>File dokumentasi kegiatan seminar wirausaha tanggal 8 Mei 2025 tidak bisa diakses, muncul
                            error "404 not found".</p>
                    </div>
                    <div class="admin-feedback">
                        <p><span class="admin-name">Admin Teknis</span> <span class="admin-date">12 Mei 2025,
                                14:05</span></p>
                        <p>Kami sedang mengalami kendala teknis pada server penyimpanan. Tim IT sedang melakukan
                            perbaikan dan diharapkan akan selesai dalam 1-2 hari kerja. Mohon kesabarannya.</p>
                    </div>
                </div>
            </div>

            <!-- Report Item 3 -->
            <div class="report-item" data-status="waiting">
                <div class="report-header" onclick="toggleReport(this)">
                    <div style="display: flex; align-items: center;">
                        <h3>Nama tidak tercantum di daftar panitia</h3>
                        <span class="report-date">13 Mei 2025</span>
                    </div>
                    <span class="report-status status-waiting">Menunggu</span>
                </div>
                <div class="report-content" style="display: none;">
                    <div class="report-message">
                        <p>Saya sudah terdaftar sebagai panitia divisi konsumsi untuk acara Dies Natalis, tetapi nama
                            saya tidak tercantum dalam daftar panitia di sistem.</p>
                    </div>
                    <div class="admin-feedback">
